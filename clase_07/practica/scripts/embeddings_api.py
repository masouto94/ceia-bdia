...
para cargar la base (scripts/cargar_datos.py). Existe para que la interfaz
web (Next.js) pueda pedir el vector de una pregunta sin tener que correr
sentence-transformers en Node.
...
from cargar_datos import MODELO_POR_DEFECTO, prefijo_consulta, prefijo_pasaje  # noqa: E402

MODELO_NOMBRE = os.environ.get("MODELO_EMBEDDING", MODELO_POR_DEFECTO)

app = FastAPI(title="Embeddings API - Clase 7", version="1.0")
